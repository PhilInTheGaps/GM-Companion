...
AudioEditor::AudioEditor(QObject *parent) : QObject(parent)
{
    ...
    //    connect(previewPlayer, SIGNAL(positionChanged(qint64)), this,
    // SLOT(previewPlayer_positionChanged(qint64)));
...
//        loadFolderContentsToTreeView(ui->treeWidget_music,
// settingsManager->getSetting(musicPath));

//
//
//   ui->treeWidget_sound->header()->setSectionResizeMode(QHeaderView::ResizeToContents);
//        loadFolderContentsToTreeView(ui->treeWidget_sound,
// settingsManager->getSetting(soundPath));

//
//
//   ui->treeWidget_radio->header()->setSectionResizeMode(QHeaderView::ResizeToContents);
//        loadFolderContentsToTreeView(ui->treeWidget_radio,
// settingsManager->getSetting(radioPath));
...
// void AudioEditor::loadFolderContentsToTreeView(QTreeWidget *treeWidget,
// QString baseFolder)
// {
...
// void AudioEditor::addSubFoldersToTreeItem(QTreeWidgetItem *baseItem, QString
// baseFolder, bool topLevel, QTreeWidget *tree)
// {
...
// void AudioEditor::addFilesToTreeItem(QTreeWidgetItem *baseItem, QString
// baseFolder, bool topLevel, QTreeWidget *tree)
// {
//    QStringList fileFormats = { ".mp3", ".wav", ".ogg", ".flac", ".m3u",
// ".pls" };
...
//    {
//        QSettings settings(settingsManager->getSetting(audioPath) + "/" +
// projectName + ".ini", QSettings::IniFormat);
...
// {
//    // Setting up QSettings
//    QSettings *settings = new QSettings(settingsManager->getSetting(audioPath)
// + "/" + projectName + ".ini", QSettings::IniFormat);

//    QStringList scenarios;
//    int scenCount = settings->beginReadArray(catItem->text(0) +
// "_Scenarios_Order");
...
//        if ((catItem->text(0) == currentCategory) && (scenario ==
// currentScenario)) scenItem->setExpanded(true);
...
// void AudioEditor::loadElement(QTreeWidgetItem *scenItem, QString category,
// QString element, int type)
// {
//    QSettings settings(settingsManager->getSetting(audioPath) + "/" +
// projectName + ".ini", QSettings::IniFormat);
...
//    int count = settings.beginReadArray(category + "_" + scenItem->text(0) +
// suffix);
...
//        else if (type == "SoundLists") loadElement(scenItem, category, name,
// 3);
...
//        case 2:
//            arrayName = currentCategory + "_" + currentScenario +
// "_MusicLists";
//            break;
...
//    if (isProjectOpen && !currentCategory.isNull() &&
// !currentScenario.isNull() && !element.isNull())
//    {
//        QSettings settings(settingsManager->getSetting(audioPath) + "/" +
// projectName + ".ini", QSettings::IniFormat);
...
//        // Save Element Order
//        size = settings.beginReadArray(currentCategory + "_" + currentScenario
// + "_Order");
//        settings.endArray();

//        settings.beginWriteArray(currentCategory + "_" + currentScenario +
// "_Order");
//        settings.setArrayIndex(size);
//        settings.setValue("name", element);
...
//            arraySize = settings.beginReadArray(currentCategory +
// "_Scenarios");
...
//            arraySize = settings.beginReadArray(currentCategory + "_" +
// currentScenario + "_MusicLists");
...
//                            resourcesPath);
//                        ui->label_musicIcon->setPixmap(QPixmap(resPath + "/" +
// iconPath).scaledToWidth(ui->label_musicIcon->width()));
//                    }
...
//
//
//   ui->radioButton_musicListRandomOrder->setChecked(settings.value("randomPlayback",
// false).toBool());
//
//
//
...
//
//
//   ui->radioButton_musicListShuffleList->setChecked(settings.value("randomPlaylist",
// true).toBool());
//
//
//
//
//         ui->radioButton_musicListLoopList->setChecked(settings.value("loop",
// false).toBool());
//
//
//
...
//
//
//   ui->radioButton_musicListSequential->setChecked(settings.value("sequential",
// false).toBool());
...
//                    {
//                        settings.setArrayIndex(i);
//                        QString songName = settings.value("name", "UNKNOWN
// NAME").toString();
//                        QString songPath = settings.value("path", "UNKNOWN
// PATH").toString();
...
//                        QString resPath = settingsManager->getSetting(
//                            resourcesPath);
//                        ui->label_soundIcon->setPixmap(QPixmap(resPath + "/" +
// iconPath).scaledToWidth(ui->label_soundIcon->width()));
//                    }
...
//
//
//         ui->radioButton_soundListRandom->setChecked(settings.value("random",
// true).toBool());
//
//
//
//            ui->radioButton_soundListLoop->setChecked(settings.value("loop",
// false).toBool());
//
//
//
...
//
//
//   ui->radioButton_soundListSequential->setChecked(settings.value("sequential",
// false).toBool());
...
//                    {
//                        settings.setArrayIndex(i);
//                        QString soundName = settings.value("name", "UNKNOWN
// NAME").toString();
//                        QString soundPath = settings.value("path", "UNKNOWN
// PATH").toString();

//                        QListWidgetItem *item = new
// QListWidgetItem(soundName);
...
//                        QString resPath = settingsManager->getSetting(
//                            resourcesPath);
//                        ui->label_radioIcon->setPixmap(QPixmap(resPath + "/" +
// iconPath).scaledToWidth(ui->label_radioIcon->width()));
//                    }
...
// {
//    QString   projectPath = settingsManager->getSetting(audioPath) + "/" +
// projectName + ".ini";
...
//                settings.beginWriteArray(topLevelItem->text(0) + "_" +
// scenarioItem->text(0) + "_Order");
...
// ui->lineEdit_musicListDescription->text();
//            arrayName    = currentCategory + "_" + currentScenario +
// "_MusicLists";
...
//            description  = description =
// ui->lineEdit_soundListDescription->text();
//            arrayName    = currentCategory + "_" + currentScenario +
// "_SoundLists";
...
//            description  = description =
// ui->textEdit_radioDescription->toPlainText();
//            arrayName    = currentCategory + "_" + currentScenario +
// "_Radios";
...
//                        settings.setValue("randomPlayback",
// ui->radioButton_musicListRandomOrder->isChecked());
//                        settings.setValue("randomPlaylist",
// ui->radioButton_musicListShuffleList->isChecked());
//                        settings.setValue("loop",
//           ui->radioButton_musicListLoopList->isChecked());
//                        settings.setValue("sequential",
//     ui->radioButton_musicListSequential->isChecked());
//                    }

//                    // Sound specific
//                    if (item->type() == 3)
//                    {
//                        settings.setValue("random",
//     ui->radioButton_soundListRandom->isChecked());
//                        settings.setValue("loop",
//       ui->radioButton_soundListLoop->isChecked());
//                        settings.setValue("sequential",
// ui->radioButton_soundListSequential->isChecked());
//                    }
...
// void AudioEditor::on_listWidget_musicList_itemDoubleClicked(QListWidgetItem
// *item)
// {
//    delete item;
// }
...
// void AudioEditor::on_listWidget_soundList_itemDoubleClicked(QListWidgetItem
// *item)
// {
//    delete item;
// }
...
//            QListWidgetItem *listItem = new
// QListWidgetItem(item->text(column));
...
// void AudioEditor::on_treeWidget_music_itemDoubleClicked(QTreeWidgetItem
// *item, int column)
// {
...
// void AudioEditor::on_treeWidget_sound_itemDoubleClicked(QTreeWidgetItem
// *item, int column)
// {
...
// void AudioEditor::on_treeWidget_radio_itemDoubleClicked(QTreeWidgetItem
// *item, int column)
// {
...
//        for (int i = 0; i < ui->treeWidget_categories->topLevelItemCount();
// i++)
//        {
//            // Get the correct category item
//            QTreeWidgetItem *catItem =
// ui->treeWidget_categories->topLevelItem(i);
...
//            {
//                QString relativePath =
// path.replace(settingsManager->getSetting(musicPath), "");
//                relativePath += "/" + file;
...
//    for (int i = 0; i < widget->count(); i++)
//    {
//        if (!QFile(settingsManager->getSetting(s) + "/" +
// widget->item(i)->whatsThis()).exists())
//        {
//            list.append(i);
//        }
//    }
...
//    label->setPixmap(QPixmap(resPath + "/" +
// path).scaledToWidth(label->width()));
// }
...
// void AudioEditor::on_treeWidget_music_currentItemChanged(QTreeWidgetItem
// *current)
// {
//    if (current->type() == 1)
//    {
...
// void AudioEditor::on_treeWidget_sound_currentItemChanged(QTreeWidgetItem
// *current)
// {
//    if (current->type() == 1)
//    {
...
// {
//    if (ui->listWidget_musicList->currentItem() != NULL) delete
// ui->listWidget_musicList->currentItem();
// }

//// Remove sound file from list
// void AudioEditor::on_pushButton_removeSoundFile_clicked()
// {
//    if (ui->listWidget_soundList->currentItem() != NULL) delete
// ui->listWidget_soundList->currentItem();
// }
...
//            if ((index + steps > -1) && (index + steps <
// ui->treeWidget_categories->topLevelItemCount()))
//            {
//                QTreeWidgetItem *temp =
// ui->treeWidget_categories->takeTopLevelItem(index);
//                ui->treeWidget_categories->insertTopLevelItem(index + steps,
// temp);
