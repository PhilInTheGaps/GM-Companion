        ...
        Column {
            ...
            Row {
                ...
                ComboBox {
                    ...
                    onCurrentTextChanged: {
                        length_output.text = converter_tool.convertLength(
                                    currentText, length_units_2.currentText,
                ...
                ComboBox {
                    ...
                    onCurrentTextChanged: {
                        length_output.text = converter_tool.convertLength(
                                    length_units_1.currentText, currentText,
                                    length_units_text_1.text)
                    }
                }
            }
            ...
            Row {
                ...
                ComboBox {
                    ...
                    onCurrentTextChanged: {
                        volume_output.text = converter_tool.convertVolume(
                                    currentText, volume_units_2.currentText,
                ...
                ComboBox {
                    ...
                    onCurrentTextChanged: {
                        volume_output.text = converter_tool.convertVolume(
                                    volume_units_1.currentText, currentText,
                                    volume_units_text_1.text)
                    }
                }
            }
            ...
            Row {
                ...
                ComboBox {
                    ...
                    onCurrentTextChanged: {
                        weight_output.text = converter_tool.convertWeight(
                                    currentText, weight_units_2.currentText,
                ...
                ComboBox {
                    ...
                    onCurrentTextChanged: {
                        weight_output.text = converter_tool.convertWeight(
                                    weight_units_1.currentText, currentText,
                                    weight_units_text_1.text)
                    }
                }
            }
