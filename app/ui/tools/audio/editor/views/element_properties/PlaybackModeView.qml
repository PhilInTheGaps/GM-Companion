    ...
    Row {
        ...
        CustomToolBarButton {
            ...
            iconColor: audio_editor && audio_editor.currentElement
                       && audio_editor.currentElement.mode === 0 ? "green" : palette.text
        ...
        CustomToolBarButton {
            ...
            pointSize: 18
            iconColor: audio_editor && audio_editor.currentElement
                       && audio_editor.currentElement.mode === modeNum ? "green" : palette.text
        ...
        CustomToolBarButton {
            ...
            pointSize: 18
            iconColor: audio_editor && audio_editor.currentElement
                       && audio_editor.currentElement.mode === 2 ? "green" : palette.text
