...
QStringList getCharacterList(){
    qDebug() << QCoreApplication::translate("Characters","Getting Characters...");
    ...
    qDebug() << QCoreApplication::translate("Characters","Characters found: ")+QString::number(characterFileNames.length());
