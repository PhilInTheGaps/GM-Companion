...
public:
    ...
    void setId(QString id) { m_id = id; emit imageChanged(); }

    QString author() const { return m_author; }
    void setAuthor(QString author) { m_author = author; emit imageChanged(); }

    QString authorId() const { return m_authorId; }
    void setAuthorId(QString authorId) { m_authorId = authorId; emit imageChanged(); }

    QString authorLink() const { return "https://unsplash.com/@" + m_authorId; }

    QStringList tags() const { return m_tags; }
    void setTags(QStringList tags) { m_tags = tags; emit imageChanged(); }
    void addTag(QString tag) { m_tags.append(tag); emit imageChanged(); }
