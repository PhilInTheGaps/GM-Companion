...
class AudioScenario : public TreeItem
{
    Q_OBJECT
public:
    AudioScenario(const QString &name, const QString &path, const AudioScenarioElements& elements, AudioCategory *parent);
    AudioScenario(const QString &name, const QString &path, const AudioScenarioElements& elements, AudioScenario *parent);
    AudioScenario(const QJsonObject &object, const QString &path, AudioCategory *parent);
    AudioScenario(const QJsonObject &object, const QString &path, AudioScenario *parent);
    ...
    [[nodiscard]] auto isSubscenario() const -> bool { return m_isSubscenario; }
...
private:
    AudioScenario(const QString &name, const QString &path, const AudioScenarioElements& elements, QObject *parent);
